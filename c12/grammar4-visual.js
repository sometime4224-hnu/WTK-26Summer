(function () {
    ...
    const config = window.C12_GRAMMAR4_VISUAL_PAGE;
        ...
        return `
            <article class="story-card" data-story-id="${esc(card.id)}">
                <div class="story-media">
                    <img src="${esc(card.image)}" width="1448" height="1086" alt="${esc(card.alt)}" loading="lazy" decoding="async" />
    ...
    function renderShell() {
        root.innerHTML = `
            ...
            <nav class="footer-nav" aria-label="문법 이동">
                <a class="nav-link" href="grammar3.html">문법 3</a>
                <a class="nav-link" href="index.html">12과 목록</a>
                <a class="nav-link" href="grammar4-classic.html">기존 버전</a>
                <a class="nav-link primary" href="grammar4-form-typing.html">활용형·문장 완성</a>
            </nav>
        `;
    }
