(function () {
    ...
    const config = window.C12_GRAMMAR_PAGE;
    ...
    document.body.classList.add("c12-grammar-page");
    document.body.style.setProperty("--c12-accent", theme.accent);
    document.body.style.setProperty("--c12-accent-dark", theme.accentDark);
    document.body.style.setProperty("--c12-accent-soft", theme.accentSoft);
    document.body.style.setProperty("--c12-accent-line", theme.accentLine);
    ...
    function renderViTranslation(text, extraClass) {
        if (!text) return "";
        const classes = `quiz-translation${extraClass ? ` ${extraClass}` : ""}`;
    ...
    function renderFooterNav() {
        ...
        links.push('<a class="nav-link" href="index.html">12과 목록</a>');
        if (config.next) {
                ...
                <div class="practice-grid">
                    ...
                    <article class="practice-card">
                        ...
                        <div class="question-box">
                            ...
                            <p id="qHintVi" class="quiz-hint quiz-translation" data-lang="vi" lang="vi"></p>
                        </div>
