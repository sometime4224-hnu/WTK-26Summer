(function () {
    ...
    const config = window.C12_GRAMMAR2_VISUAL_PAGE;
        ...
        return `
            <article class="story-card" data-story-id="${esc(card.id)}">
                <div class="story-media">
                    <img src="${esc(card.image)}" width="1055" height="1491" alt="${esc(card.alt)}" loading="lazy" decoding="async" />
    ...
    function renderShell() {
        root.innerHTML = `
            ...
            <section class="support-panel" aria-label="문법 2 연결 활동">
                <div>
            ...
            <nav class="footer-nav" aria-label="문법 이동">
                <a class="nav-link" href="grammar1.html">문법 1</a>
                <a class="nav-link" href="index.html">12과 목록</a>
                <a class="nav-link" href="grammar2-classic.html">기존 버전</a>
                <a class="nav-link primary" href="grammar3.html">문법 3</a>
            </nav>
        `;
    }
