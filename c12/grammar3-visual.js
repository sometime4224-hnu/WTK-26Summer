(function () {
    ...
    const config = window.C12_GRAMMAR3_VISUAL_PAGE;
    const root = document.getElementById("visualPage");
    ...
    function renderStoryCard(card) {
        const body = card.bodyHtml || esc(card.body);
        const example = card.exampleHtml || esc(card.example);
        return `
            <article class="story-card" data-story-id="${esc(card.id)}">
                ...
                <div class="story-copy">
                    ...
                    <p>${body}</p>
                    <div class="story-example">${example}</div>
    ...
    function renderShell() {
        root.innerHTML = `
            ...
            <section class="support-panel" aria-label="문법 3 연결 활동">
                <div>
                    <p class="support-panel__title">연결 활동</p>
                    <p class="support-panel__desc">이미지로 단서와 형태 흐름을 잡은 뒤, 전체 이미지 보기와 문장 완성으로 바로 이어 갈 수 있습니다.</p>
                </div>
                <div class="support-links">
                    <a class="resource-link" href="grammar3-support-activity1.html">보조활동 1 · 설명 이미지</a>
                    <a class="resource-link" href="grammar3-form-typing.html">활용형·문장 완성</a>
                    <a class="resource-link" href="grammar3-classic.html">기존 버전</a>
                </div>
            </section>
            ...
            <nav class="footer-nav" aria-label="문법 이동">
                <a class="nav-link" href="grammar2.html">문법 2</a>
                <a class="nav-link" href="index.html">12과 목록</a>
                <a class="nav-link" href="grammar3-classic.html">기존 버전</a>
                <a class="nav-link" href="grammar4.html">문법 4</a>
                <a class="nav-link primary" href="grammar3-form-typing.html">활용형·문장 완성</a>
            </nav>
        `;
    }
    ...
    function openLightbox(card) {
        ...
        refs.lightboxCaption.textContent = card.caption || card.example || "";
